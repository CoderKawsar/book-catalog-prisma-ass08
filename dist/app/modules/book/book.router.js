...
// create Book
router.post("/", (0, auth_1.default)(users_1.ENUM_USER_ROLE.ADMIN), book_controller_1.BookController.createBook);
// get all Books
router.get("/", book_controller_1.BookController.getAllBooks);
// get single Book by id
router.get("/:id", (0, auth_1.default)(users_1.ENUM_USER_ROLE.ADMIN), book_controller_1.BookController.getSingleBookOrCategoryBooksById);
